...
const Profitalyze = () => {
  ...
  // Sample data - this would be fed from your data source
      ...
      return (
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Sales Bar Chart */}
            <div className="bg-[#dff24f] hoverrounded-lg shadow-md p-6 border border-gray-200">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={salesData}>
                  ...
                  <Legend />
                  <Bar dataKey="sales" fill="#00000" name="Sales" />
            ...
            <div className="hidden md:flex md:space-x-8 items-center">
              {['home', 'products', 'insights', 'analytics', 'reports'].map((page) => (
                <button
                  ...
                  className={`w-24 text-center px-3 py-2 rounded-xl text-sm font-medium transition-colors ${currentPage === page
                    ? 'text-black bg-[#dff24f]'
                    : 'text-white hover:text-black hover:bg-[#dff24f]'
                    }`}
                >
